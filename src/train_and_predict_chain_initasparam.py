...
from train_and_predict_chain import MLP1H, MLP2H, MLP2H_Separable_Hamilt, MLP_General_Hamilt, MLP1H_Separable_Hamilt, MLP3H_Separable_Hamilt, PlainRNN, myLSTM
